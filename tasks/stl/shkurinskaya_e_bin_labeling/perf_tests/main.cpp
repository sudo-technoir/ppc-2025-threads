...
TEST(shkurinskaya_e_bin_labeling_stl, test_pipeline_run) {
  int height = 5000;
  int width = 5000;
  ...
  // Create Task
  auto task_stl = std::make_shared<shkurinskaya_e_bin_labeling_stl::TaskSTL>(task_data_stl);
...
TEST(shkurinskaya_e_bin_labeling_stl, test_task_run) {
  int height = 5000;
  int width = 5000;
  int size = width * height;
  // Create data
