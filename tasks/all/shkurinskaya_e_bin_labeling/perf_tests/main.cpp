...
TEST(shkurinskaya_e_bin_labeling_all, test_pipeline_run) {
  ...
  // Create Task
  auto task_all = std::make_shared<shkurinskaya_e_bin_labeling_all::TaskMPITBB>(task_data_all);
...
TEST(shkurinskaya_e_bin_labeling_all, test_task_run) {
  boost::mpi::communicator world;
  int height = 5000;
  int width = 5000;
  int size = width * height;
